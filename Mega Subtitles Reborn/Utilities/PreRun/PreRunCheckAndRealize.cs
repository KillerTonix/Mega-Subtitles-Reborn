...
namespace Mega_Subtitles_Reborn.Utilitis.PreRun
{
    public class PreRunCheckAndRealize
    {
        ...
        private static void AssignVaraiblesToSettings()
        {
            ...
            GeneralSettings.Default.ReaperSyncFilePath = Path.Combine(GeneralSettings.Default.GeneralCacheFolderPath, "SyncForCSharp.txt");
            GeneralSettings.Default.ReaperCommandsFilePath = Path.Combine(GeneralSettings.Default.GeneralCacheFolderPath, "ReaperCommands.json");
            ...
            GeneralSettings.Default.DemoPhrasesPath = Path.Combine(GeneralSettings.Default.ProjectCacheFolderPath, "DemoPhrases.json");
